<template>
  <div class="page">
    ...
    <div class="flex-center" style="min-height: 126px;background: url('/images/footerBg.png') no-repeat;background-size: 100% 100%;">
      <Button type="default" ghost>联系我们</Button>
    </div>
  </div>
</template>
